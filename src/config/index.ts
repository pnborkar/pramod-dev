...
export const SITE_CONTENT: SiteContent = {
 ...
 about: {
  description: `
    I'm a Senior Solutions Architect at Neo4j, based in the Bay Area. My days are spent in the field — discovery calls, architecture reviews, and POCs where graph meets the lakehouse. My evenings are for demos that explore where those stacks are heading.
    ...
    \n I write occasionally about graph, lakehouses, and the evolving data stack. If any of that is interesting, <a href="mailto:pnborkar@gmail.com">let's talk.</a>
  `,
  image: "/pramod2.jpg",
  },
};
